...
function ResponsiveDrawer(props) {
    ...
    //     console.log(db_columns,'dbcolumn')
    ...
    const routes = [
        <Route
          path="/"
          element={<Columns databaseName="SPF_F1_DAY" />}
        />,
        <Route
          key='1'
          path="/SPF_F1_DAY/Pump-1 current"
          element={<Columns databaseName="SPF_F1_DAY" columnName="Pump-1 current" />}
        />,
        <Route
          key='2'
          path="/SPF_F1_DAY/Pump-2 current"
          element={<Columns databaseName="SPF_F1_DAY" columnName="Pump-2 current" />}
        />,
        <Route
          key='3'
          path="/SPF_F1_DAY/Pump-3 current"
          element={<Columns databaseName="SPF_F1_DAY" columnName="Pump-3 current" />}
        />,
      ];
